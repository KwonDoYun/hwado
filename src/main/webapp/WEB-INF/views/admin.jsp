...
<body class="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<%@ include file="include/include_admin.jsp"%>
	...
	<script>
		...
		function openEdtNh() {
			...
			// alert("asd"+id_check.substr(6));
			var userId = id_check.substr(6);
			var acMents = document.getElementById('selectAchMent').options[document.getElementById('selectAchMent').selectedIndex].text;

			// location.href = "${pageContext.request.contextPath}/admin_registe.do?acMents="+num;
			
			$.ajax({
				type:"POST",
				url:"${pageContext.request.contextPath}/admin_registe.do",
				data: {
					"userId": userId,
					"acMents": acMents
				},
