											...
											<div id="contAreaBox">
												<div class="panel">
													<div class="panel-body">
														<form role="form" action="/community/general_board/update.do" method="post">
																	...
																	<tbody>
																		<tr>
																			...
																			<td class="form-inline"><span
																				style="width: 200px">${showBoardWriteUserNickname}</span></td>
																		</tr>
																		<tr>
																			<th class="active">제목</th>
																			<td class="form-inline"><input type="text"
																				id="boardTitle" name="boardTitle"
																				class="form-control" style="width: 840px" value="${showBoardContent.boardTitle} "/></td>
																		</tr>
																		<tr>
																			<th class="active">내용</th>
																			<td class="form-inline"><textarea type="text" id="content"
																					name="content" cols="100" rows="10"
																					class="form-control">${showBoardContent.content}</textarea></td>
																		</tr>
																		<tr>
																			<th class="active"></th>
															...
															<input type="hidden" id="boardId" name="boardId" value="${showBoardContent.boardId}">
															</div>
