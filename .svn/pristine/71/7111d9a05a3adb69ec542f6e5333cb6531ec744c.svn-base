						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="dataTable">
									...
									<tbody>
										<c:forEach items="${notice_list}" var="list" varStatus="status">
											<tr>
												<td>${list.boardId}</td>
												<td><a class="id" href="${pageContext.request.contextPath}/notice/showForm?boardId=${list.boardId}">${list.boardTitle}</a></td>
